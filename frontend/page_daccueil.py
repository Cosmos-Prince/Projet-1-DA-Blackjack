...
background_label = tk.Label(fenetre, image=bg_image)
background_label.place(x=0, y=0, relwidth=1, relheight=1)
background_label.lower()

# Création du frame du titre
frameTitre = tk.Frame(fenetre, bg="#0b7821", padx=20, pady=20, height=100, width=(largeur - 0))
...
boutton_distribuer = bouton_personnalise(fenetre, text="Jouer" )
...
liste = tk.OptionMenu(fenetre, choix_joueurs, "1 joueur")
...
# Bouton "i"
btn_info = bouton_personnalise(fenetre, text="i", command=afficher_regles)
